...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="<?php echo $URL;?>" class="brand-link">
            <img src="<?php echo $URL;?>/public/images/logo2.png" alt="Prolaptop logo" class="brand-image img-circle elevation-2" style="">
            <span class="brand-text font-weight-light">ProLaptop</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="<?php echo $URL;?>/public/templeates/AdminLTE-3.2.0/dist/img/logo-black.png" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                    <a href="<?php echo $URL;?>/usuarios" class="d-block"><?php echo $nombres_sesion;?></a>
                </div>
            </div>
