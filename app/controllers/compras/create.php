...
VALUES (:id_producto,:nro_compra,:fecha_compra,:id_proveedor,:comprobante,:id_usuario,:precio_compra,:cantidad,:fyh_creacion,:fyh_actualizacion)");
...
if($sentencia->execute()){
    ...
    $_SESSION['mensaje'] = "Se registró la compra exitosamente";
