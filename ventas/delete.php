                ...
                <div class="col-md-3">
                    <div class="card card-outline card-danger">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <hr>
                                <button id="btn_delete_venta" class="btn btn-danger btn-block">Borrar venta</button>
                                <div id="btn_delete_venta"></div>
                            
                            <script>
                                $('#btn_delete_venta').click(function () {
